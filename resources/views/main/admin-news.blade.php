...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <button class="btn btn-danger" id="multi-delete" data-route="{{ route('multi-delete.news') }}">Delete All Selected</button>
                    ...
                    <tbody>
                        @forelse ($news as $n)
                            <tr>
                                ...
                                <td>{{ $n->title }}</td>
                                <td>
                                    <button type="button" class="btn btn-circle btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#id{{ $n->id }}">
                                    ...
                                    <div class="modal-body">
                                        <div class="container">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-9">{{ \Carbon\Carbon::parse($n->date)->format('F d, Y') }}</div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-9"><img src="{{ asset('uploads/news/' . \Carbon\Carbon::createFromFormat('Y-m-d', $n->date)->format('Y') . '/' . \Illuminate\Support\Str::slug($n->title, '-') . '/' . $n->image) }}" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
