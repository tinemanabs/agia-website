...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <button class="btn btn-danger" id="multi-delete" data-route="{{ route('multi-delete.member') }}">Delete All
                Selected</button>
                    ...
                    <tbody>
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td>{{ $user->email }}</td>
                                <td>{{ '@' . $user->username }}</td>
                                <td><button type="button" class="btn btn-circle btn-sm btn-primary" data-bs-toggle="modal"
