...
@section('title', 'Add a Secretariat')
@section('content')
    <div class="container px-lg-5">
        <a class="btn btn-primary  btn-sm mb-3" href="{{ route('admin.view-all-secretariat') }}" role="button">Back</a>
        <div class="card">
            <div class="card-body">
                <h3 class="mb-3">Add a Secretariat</h3>
                <form action="{{ route('add.secretariat') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-primary" type="submit" id="add-secretariat-btn">Add to The Secretariat</button>
                    </div>
                </form>
            </div>
        </div>
