            ...
            <div class="d-flex" id="wrapper">
                ...
                <div class=" bg-white" id="sidebar-wrapper">
                    ...
                    <div class="list-group list-group-flush">
                        <a class="list-group-item p-3 {{ Route::is('training.calendar') ? 'active' : '' }}"
                            href="{{ route('training.calendar') }}">Training Calendar</a>
                        <a class="list-group-item p-3 {{ Route::is('training.training-events') ? 'active' : '' }}"
                            href="{{ route('training.training-events') }}">List of Training
                            Events</a>
                        <a class="list-group-item p-3 {{ Route::is('training.training-cpd-units') ? 'active' : '' }}"
                            href="{{ route('training.training-cpd-units') }}">Training with CDP
                            Units</a>
                        <a class="list-group-item p-3 {{ Route::is('training.in-house-trainings') ? 'active' : '' }}"
                            href="{{ route('training.in-house-trainings') }}">In-house
                            Trainings</a>
                        <a class="list-group-item p-3 {{ Route::is('training.mobile-training') ? 'active' : '' }}"
                            href="{{ route('training.mobile-training') }}">Mobile Training</a>
                    </div>
                </div>
